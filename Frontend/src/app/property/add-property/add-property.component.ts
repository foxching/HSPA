...
export class AddPropertyComponent {
  ...
  allTabsValid(): boolean {
    if (this.formTabs && this.BasicInfo.invalid) {
      this.formTabs.tabs[0].active = true;
      return false;
    }

    if (this.formTabs && this.PriceInfo.invalid) {
      this.formTabs.tabs[1].active = true;
      return false;
    }

    if (this.formTabs && this.AddressInfo.invalid) {
      this.formTabs.tabs[2].active = true;
      return false;
    }

    if (this.formTabs && this.OtherInfo.invalid) {
